...
- [Últimos posts](/archives) — lo más reciente en orden cronológico inverso.
- [Categorías](/categories) y [tags](/tags) — para encontrar lo que te interesa.
- [Sobre el blog](/about) — contexto y motivación.
- [RSS](/rss.xml) — suscríbete y olvídate de volver a acordarte de la URL.

## Para no perderte nada

Suscríbete al [RSS](/rss.xml) o revisa los [últimos posts](/archives) cuando quieras.
